...
| 3D-модели, анимация, текстуры, прозрачность | **Потоковая музыка** молчит; звуковые эффекты играют |
| Звуковые эффекты и музыка через SAS | **Видеоролики** пропускаются |
| Клавиатура и геймпады с настоящей камерой на правом стике | Кривые поверхности, сеть |
...
- Потоковая музыка и видеоролики
