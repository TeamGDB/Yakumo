...
| --- | --- |
| Загрузка, меню, создание персонажа, деревня и охотничьи локации | **Мультиплеер**: клиент ad hoc написан, но ещё не влит (#2) |
| Сохранения в формате самой PSP, включая сохранения и загружаемые квесты, перенесённые с PSP | На экране наград после квеста за панелями виден шум (#48) |
| 3D-модели, анимация, текстуры, прозрачность, освещение и туман | Буквы в тексте иногда обрезаются (#53); на плиточных 2D-экранах выше ×1 видны тонкие швы (#55) |
| Звуковые эффекты, потоковая музыка и видеоролики (с FFmpeg) | Кривые поверхности; диалоги сохранения пока ничего не рисуют (#33) |
...
- Мультиплеер через ad hoc-серверы, которыми уже пользуются игроки на PSP (#2)
