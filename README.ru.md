...
| --- | --- |
| Загрузка, меню, создание персонажа, деревня и охотничьи локации | На экране наград после квеста за панелями виден шум (#48) |
| Сохранения в формате самой PSP, включая сохранения и загружаемые квесты, перенесённые с PSP | На плиточных 2D-экранах выше ×1 видны тонкие швы (#55) |
| 3D-модели, анимация, текстуры, прозрачность, освещение и туман | Кривые поверхности; диалоги сохранения пока ничего не рисуют (#33) |
| Звуковые эффекты, потоковая музыка и видеоролики (с FFmpeg) | |
| Клавиатура и геймпады с настоящей камерой на правом стике | |
| Внутриигровое меню с настройками видео, звука и управления | |
| Все 355 оверлеев кода рекомпилированы | |
| Мультиплеер через ad hoc-серверы, которыми пользуются игроки на PSP: зал сбора и совместные квесты | |
